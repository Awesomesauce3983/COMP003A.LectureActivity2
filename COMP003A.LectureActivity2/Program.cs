...
namespace COMP003A.LectureActivity2
{
    internal class Program
    {
        static void Main(string[] args)
        {
             ...
             * these types are the building blocks of a much larger type system.                 * using var for a variable’s type tells the compiler to infer its type from 
            ...
            int arithmetic2 = 3 + 1; // declaring arithmetic2 and assigning a value to arithmetic2 all at once158
